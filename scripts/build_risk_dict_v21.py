    ...
    "D": [
        {
            ...
            "keywords": [
                ...
                "利润与现金流", "经营现金流量净额", "现金含量",
            ],
            "regexes": [
                r"(?:经营|经营性)?(?:现金|现金流).{0,14}(?:净额|流入).{0,14}(?:与利润|与净利润).{0,10}(?:匹配|背离|差异|是否合理)",
                r"(?:净利润|利润).{0,12}(?:大幅)?(?:高于|低于).{0,6}(?:经营)?(?:现金|现金流).{0,10}(?:净额)?",
            ],
            "note": "扩展标签：经营现金流与利润匹配",
        },
        {
